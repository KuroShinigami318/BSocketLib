...
public:
	...
	virtual ISocketReactor::ReactorResult DeregisterEventHandler(SocketEvent i_event) = 0;
private:
	friend class Socket_internal;
	virtual ISocketReactor::ReactorResult ProcessAsyncRawData(void* i_rawData, SocketEvent i_eventType, ISocket* i_socket) = 0;
};
